...
parser.add_argument(
    '--path_to_p_value_circle_plot_png',
    type=str,
    required=True,
)
parser.add_argument(
    '--path_to_p_value_legend_png',
    type=str,
    required=True,
)
parser.add_argument(
    '--path_to_p_value_arrow_legend_png',
    type=str,
    required=True,
)
parser.add_argument(
    '--path_to_p_value_circle_plot_pdf',
    type=str,
    required=True,
)
parser.add_argument(
    '--path_to_p_value_legend_pdf',
    type=str,
    required=True,
)
parser.add_argument(
    '--path_to_p_value_arrow_legend_pdf',
    type=str,
    required=True,
)
parser.add_argument(
...
path_to_p_value_circle_plot_png: str = args.path_to_p_value_circle_plot_png
path_to_p_value_legend_png: str = args.path_to_p_value_legend_png
path_to_p_value_arrow_legend_png: str = args.path_to_p_value_arrow_legend_png
path_to_p_value_circle_plot_pdf: str = args.path_to_p_value_circle_plot_pdf
path_to_p_value_legend_pdf: str = args.path_to_p_value_legend_pdf
path_to_p_value_arrow_legend_pdf: str = args.path_to_p_value_arrow_legend_pdf
...
def main():
    ...
    fig.savefig(path_to_p_value_circle_plot_png, dpi=300)
    legend_fig.savefig(path_to_p_value_legend_png, dpi=300)
    arrow_legend_fig.savefig(path_to_p_value_arrow_legend_png, dpi=300)

    fig.savefig(path_to_p_value_circle_plot_pdf, dpi=300)
    legend_fig.savefig(path_to_p_value_legend_pdf, dpi=300)
    arrow_legend_fig.savefig(path_to_p_value_arrow_legend_pdf, dpi=300)
